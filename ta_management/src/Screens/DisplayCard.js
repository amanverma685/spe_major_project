...
{/* <img class="w-10 h-10 rounded" src="/docs/images/people/profile-picture-5.jpg" alt="Default avatar"> */}
      ...
      <div className="px-4 py-2 m-2">
        ...
        {
          (show === true) && <StudentDetails onClose={setShow} show={show} id={props.e.id} name={props.e.name} grade={props.e.subject} achievements={props.e.achievements} email={props.e.email}/>
        }
        </div>
      </div>
    </div>
